...
type BookstoreClient interface {
	...
	// 返回指定的书籍
	GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*GetBookRequesResponse, error)
	// 从书架上删除书籍
...
func (c *bookstoreClient) GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*GetBookRequesResponse, error) {
	out := new(GetBookRequesResponse)
...
type BookstoreServer interface {
	...
	// 返回指定的书籍
	GetBook(context.Context, *GetBookRequest) (*GetBookRequesResponse, error)
	// 从书架上删除书籍
...
func (UnimplementedBookstoreServer) GetBook(context.Context, *GetBookRequest) (*GetBookRequesResponse, error) {
