...
const (
	Gretter_SayHello_FullMethodName = "/sayhello.Gretter/SayHello"
)
...
func (c *gretterClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*SayHelloResponse, error) {
...
func (UnimplementedGretterServer) SayHello(context.Context, *SayHelloRequest) (*SayHelloResponse, error) {
...
func _Gretter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GretterServer).SayHello(ctx, req.(*SayHelloRequest))
	}
