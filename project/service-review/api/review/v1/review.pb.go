...
type ListReviewByStoreIDResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListReviewByStoreIDResponse) Reset() {
	*x = ListReviewByStoreIDResponse{}
	mi := &file_review_v1_review_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListReviewByStoreIDResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListReviewByStoreIDResponse) ProtoMessage() {}

func (x *ListReviewByStoreIDResponse) ProtoReflect() protoreflect.Message {
	mi := &file_review_v1_review_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListReviewByStoreIDResponse.ProtoReflect.Descriptor instead.
func (*ListReviewByStoreIDResponse) Descriptor() ([]byte, []int) {
	return file_review_v1_review_proto_rawDescGZIP(), []int{1}
}

func (x *ListReviewByStoreIDResponse) GetList() []*ReviewInfo {
	if x != nil {
		return x.List
	}
	return nil
...
type CreateReviewRequest struct {
	...
	ExpreeScore   int32                  `protobuf:"varint,6,opt,name=expreeScore,proto3" json:"expreeScore,omitempty"`
...
const file_review_v1_review_proto_rawDesc = "" +
	...
	"\x1bListReviewByStoreIDResponse\x12-\n" +
	"\x04list\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04list\"\x87\x03\n" +
	...
	"\vexpreeScore\x18\x06 \x01(\x05B\x0f\xfaB\f\x1a\n" +
	...
	"\x13ListReviewByStoreID\x12).api.review.v1.ListReviewByStoreIDRequest\x1a*.api.review.v1.ListReviewByStoreIDResponse\"\x00B2\n" +
...
var file_review_v1_review_proto_goTypes = []any{
	...
	(*ListReviewByStoreIDResponse)(nil), // 1: api.review.v1.ListReviewByStoreIDResponse
	...
	(*AuditRrviewRequest)(nil),          // 7: api.review.v1.AuditRrviewRequest
	(*AuditRrviewReply)(nil),            // 8: api.review.v1.AuditRrviewReply
	...
	(*AuditAppealRequest)(nil),          // 15: api.review.v1.AuditAppealRequest
	(*AuditAppealReply)(nil),            // 16: api.review.v1.AuditAppealReply
}
var file_review_v1_review_proto_depIdxs = []int32{
	6,  // 0: api.review.v1.ListReviewByStoreIDResponse.list:type_name -> api.review.v1.ReviewInfo
	...
	7,  // 5: api.review.v1.Review.AuditRrview:input_type -> api.review.v1.AuditRrviewRequest
	9,  // 6: api.review.v1.Review.AppealReview:input_type -> api.review.v1.AppealReviewRequest
	11, // 7: api.review.v1.Review.ReplyReview:input_type -> api.review.v1.ReplyReviewRequest
	15, // 8: api.review.v1.Review.AuditAppeal:input_type -> api.review.v1.AuditAppealRequest
	13, // 9: api.review.v1.Review.ListReviewByUserId:input_type -> api.review.v1.ListReviewByUserIdRequest
	...
	8,  // 13: api.review.v1.Review.AuditRrview:output_type -> api.review.v1.AuditRrviewReply
	...
	16, // 16: api.review.v1.Review.AuditAppeal:output_type -> api.review.v1.AuditAppealReply
	14, // 17: api.review.v1.Review.ListReviewByUserId:output_type -> api.review.v1.ListReviewByUserIdReply
	1,  // 18: api.review.v1.Review.ListReviewByStoreID:output_type -> api.review.v1.ListReviewByStoreIDResponse
...
func file_review_v1_review_proto_init() {
	...
	file_review_v1_review_proto_msgTypes[15].OneofWrappers = []any{}
	type x struct{}
