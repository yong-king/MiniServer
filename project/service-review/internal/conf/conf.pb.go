...
type Snowflake struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MechineID     int64                  `protobuf:"varint,1,opt,name=mechineID,proto3" json:"mechineID,omitempty"`
...
func (x *Snowflake) GetMechineID() int64 {
	if x != nil {
		return x.MechineID
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"G\n" +
	"\tSnowflake\x12\x1c\n" +
	"\tmechineID\x18\x01 \x01(\x03R\tmechineID\x12\x1c\n" +
	"\tstartTime\x18\x02 \x01(\tR\tstartTimeB#Z!service-review/internal/conf;confb\x06proto3"
