...
const file_api_business_v1_business_proto_rawDesc = "" +
	...
	"\bBusiness\x12s\n" +
	"\vReplyReview\x12#.api.busniess.v1.ReplyReviewRequest\x1a!.api.busniess.v1.ReplyReviewReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11b/v1/review/reply\x12w\n" +
	"\fAppealReview\x12$.api.busniess.v1.AppealReviewRequest\x1a\".api.busniess.v1.AppealReviewReply\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12b/v1/review/appealB1\n" +
...
var file_api_business_v1_business_proto_goTypes = []any{
	...
	(*AppealReviewRequest)(nil), // 2: api.busniess.v1.AppealReviewRequest
	(*AppealReviewReply)(nil),   // 3: api.busniess.v1.AppealReviewReply
}
var file_api_business_v1_business_proto_depIdxs = []int32{
	...
	2, // 1: api.busniess.v1.Business.AppealReview:input_type -> api.busniess.v1.AppealReviewRequest
	1, // 2: api.busniess.v1.Business.ReplyReview:output_type -> api.busniess.v1.ReplyReviewReply
	3, // 3: api.busniess.v1.Business.AppealReview:output_type -> api.busniess.v1.AppealReviewReply
