...
type GretterClient interface {
	SayHello(ctx context.Context, in *SayHelloRequerst, opts ...grpc.CallOption) (*SayHelloResponse, error)
}
...
func (c *gretterClient) SayHello(ctx context.Context, in *SayHelloRequerst, opts ...grpc.CallOption) (*SayHelloResponse, error) {
...
type GretterServer interface {
	SayHello(context.Context, *SayHelloRequerst) (*SayHelloResponse, error)
...
func (UnimplementedGretterServer) SayHello(context.Context, *SayHelloRequerst) (*SayHelloResponse, error) {
...
func _Gretter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GretterServer).SayHello(ctx, req.(*SayHelloRequerst))
	}
