...
const file_api_bubble_v1_todo_error_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/bubble/v1/todo_error.proto\x12\rapi.bubble.v1\x1a\x13errors/errors.proto*F\n" +
	"\vErrorReason\x12\x18\n" +
	"\x0eTODO_NOT_FOUND\x10\x00\x1a\x04\xa8E\x94\x03\x12\x17\n" +
	"\rINVALID_PARAM\x10\x01\x1a\x04\xa8E\x90\x03\x1a\x04\xa0E\xf4\x03B.\n" +
